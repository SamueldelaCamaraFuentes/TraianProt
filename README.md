...
* Download the local version `functions.R` file from "R" folder and `app.R`, `Downstreaming_Analysis_report.Rmd` and `traianprot.png ` and load them into you R session.
* Click Run app.
