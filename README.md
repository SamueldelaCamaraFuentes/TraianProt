...
* Download the local version `functions.R` file the `app.R`, `Downstreaming_Analysis_report.Rmd` and `traianprot.png ` files located in the `inst/shiny/TraianProtApp` folder and load them into you R session.
* Click Run app.
